...
possible idea/next step: intelligently merging similar ingredients? 
like, egg vs large egg vs eggs vs large eggs, tomato/es,
garlic vs garlic cloves vs minced garlic?
or, 

http://www.seriouseats.com/2014/05/all-about-mirepoix.html

https://www.finedininglovers.com/blog/food-drinks/infographic-flavor-bases-world-cuisines/

https://ourfriendben.wordpress.com/2010/06/26/cookings-trinities/

https://www.thecitycook.com/articles/2011-09-01-the-trinities

related: a bayesian probability of containing an ingredient, based on what other ingredients we know about?
so, like, if it's got carrots and celery, what is p(onion)? (probably ought to be order invariant.)

tf-idf stuff? like, relating the odds of carrots being paired with onions to the total proportion of recipes with onions?

or, markovian recipe generation.
...
def percent_containing(d, term1, term2):
	...
	for recipe in all_recipes:
		if term2 in recipe:
			contains += 1
	return float(contains)/len(all_recipes)
...
def identify_n_sets(d, n=3):
	...
	With n=3, this identifies "trinities" - things like in these sites/sources/recipes:
		http://www.seriouseats.com/2014/05/all-about-mirepoix.html
		https://www.finedininglovers.com/blog/food-drinks/infographic-flavor-bases-world-cuisines/
		https://ourfriendben.wordpress.com/2010/06/26/cookings-trinities/
		https://www.thecitycook.com/articles/2011-09-01-the-trinities
...
if __name__ == "__main__":
	...
	# "Fill in" the next ingredient for a recipe:
	# next_ing = most_likely_next_ingredient(recs, ["onion","salt","carrot"])
	# print next_ing[0]
